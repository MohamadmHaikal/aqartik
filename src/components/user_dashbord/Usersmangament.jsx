      ...
      >
        ...
        <Box>
          ...
          <Box sx={{ display: "flex", marginY: "1rem" }}>
            <Typography sx={{ marginLeft: "10px" }}>اسم المستخدم:</Typography>
        ...
        <Box>
          ...
          >
            ...
            >
              <Box sx={{ display: {xs:"block" , md:"flex"} , marginBottom:{xs:"15px" , md:"0px"} }}>
        ...
        <Modal open={isModalOpen} onClose={handleAddCloseModal}>
          ...
          >
            <Typography sx={{ fontWeight: "bold" }}>
              هل أنت متأكد من أضافة المستخدم؟
            </Typography>
            <Box
              sx={{
                marginTop: "2rem",
